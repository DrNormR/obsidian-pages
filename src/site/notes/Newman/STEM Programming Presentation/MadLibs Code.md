...
p1_birthday = "July 4"                   # str: text/string value
...
p1_likes_dogs = True                     # bool: True or False value
...
p2_birthday = "November 3"               # str: text/string value
...
p2_speaks_pig_latin = False              # bool: True or False value

# --- EXTRA CHAOTIC VARIABLES ---
...
# Secret Mad Lib Story Mappings

# These take innocent interview answers and use them in unexpected story ways

p1_reelected = p1_likes_dogs                # bool: secretly used as the President's reelection status

p2_speaks_alien = p2_speaks_pig_latin       # bool: secretly used as alien language ability

# Mathematical Absurdity Computations

height_difference = abs(p1_height_inches - p2_height_inches)

# int: positive height difference in inches
