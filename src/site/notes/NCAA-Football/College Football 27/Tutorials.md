---
{"dg-publish":true,"permalink":"/ncaa-football/college-football-27/tutorials/","noteIcon":""}
---




<iframe width="560" height="315" src="https://www.youtube.com/embed/hHseEgCdHq8?si=lxBsn8zACtxfO-l6" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>

# Passing

![Pasted image 20260915192639.png](/img/user/NCAA-Football/College%20Football%2027/~media/Pasted%20image%2020260915192639.png)

![Pasted image 20260915192817.png](/img/user/NCAA-Football/College%20Football%2027/~media/Pasted%20image%2020260915192817.png)

- practice leading receivers
- throw the pass, tap the receiver button before the ball hits the hands

# Running

![Pasted image 20260915193129.png|393](/img/user/NCAA-Football/College%20Football%2027/~media/Pasted%20image%2020260915193129.png)
- do not run in direction of the flame icons--those are unblocked
- as soon as you snap, identify the hole and use left stick only, no turbo
	- snap left stick back and forth
- if defense is in the backfield quickly, hold turbo and bounce run outside

## Option
- read option
	- identify the R player to read
	- If he crashes down, hold X
	- If he stays home, stay off of X
- RPO
	- RPO bubble out of trips
	- RPO flat
- speed option
	- identify the P pitch guy
	- pitch with L1
	- not recommended
...
HB Stretch
![Pasted image 20260916132730.png|369](/img/user/NCAA-Football/College%20Football%2027/~media/Pasted%20image%2020260916132730.png)
...
RPO Read Y Flat
![Pasted image 20260916133036.png|409](/img/user/NCAA-Football/College%20Football%2027/~media/Pasted%20image%2020260916133036.png)
- primary read is triangle receiver
- best against man, still works against zone

## <u>Gun Bunch Str Offset</u>
![Pasted image 20260916133306.png|420](/img/user/NCAA-Football/College%20Football%2027/~media/Pasted%20image%2020260916133306.png)

Dagger
![Pasted image 20260916133425.png|414](/img/user/NCAA-Football/College%20Football%2027/~media/Pasted%20image%2020260916133425.png)
- Hot route (triangle)
